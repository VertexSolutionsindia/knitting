...
public partial class Ticketadd : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            company_id = Convert.ToInt32(Session["company_id"].ToString());
            SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["Connection"]);
            SqlCommand cmd = new SqlCommand("insert into ticket_entry values(@Ticket_no,@Ticket,@Account,@contact,@assign_to,@status,@priority,@category,@product,@Product_type,@summary,@total,@payment_received,@payment_pending,@created_date)", con);
