<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Leadshow.aspx.cs" Inherits="Leadshow" %>
...
<div>
           <h1 style="text-align:center; padding-top:10px;">Email</h1>
...
<div>
           <h1 style="text-align:center; padding-top:10px;">Phone</h1>
     ...
     <div class="col-md-3 s4">
         <div>
           <h1 style="text-align:center; padding-top:10px;">Modified</h1>
...
<div class="panel-body">
  ...
  <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Campaign</h4>
     ...
     <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Customer Types</h4>
   ...
   <div class="col-md-6">
     <div class="col-md-12 s6 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Created Before</h4>
     ...
     <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Alternate Phone</h4>
     ...
     <div class="col-md-12 s6 text-center">
           <div>
           <h4 style="text-align:center; font-size:16px; padding-top:10px;">Alternate Email</h4>
 ...
 <div class="col-md-6">
  <div class="col-md-12">
        ...
        <h4 style="text-align:left; font-size:20px;color:#13c4a5 ">Address Info</h4>
