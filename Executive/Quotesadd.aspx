<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Quotesadd.aspx.cs" Inherits="Quotesadd" %>
    ...
    <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                                <div class="form-group"><label class="col-lg-3 control-label">Quote No<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox17" runat="server" class="dropbox"></asp:TextBox> 
                                    </div>
                                </div>
                               <div class="form-group"><label class="col-lg-3 control-label">Subject No<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox5" runat="server" class="dropbox"></asp:TextBox> 
                                    </div>
                                </div>
                                 <div class="form-group"><label class="col-lg-3 control-label">Opportunity<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox19" runat="server" class="dropbox"></asp:TextBox> 
                                    </div>
                                </div>
                    ...
                    <ContentTemplate>
                                            <asp:TextBox ID="TextBox9" runat="server" class="dropbox"></asp:TextBox>
                                            </ContentTemplate> 
                               <Triggers>
                                     ...
                                     <asp:UpdatePanel ID="UpdatePanel112" runat="server" >
                                         <ContentTemplate>
                                           <asp:DropDownList ID="DropDownList4" runat="server" 
                                            class="dropbox" AutoPostBack="true" onselectedindexchanged="DropDownList4_SelectedIndexChanged"></asp:DropDownList>
                                      </ContentTemplate> 
                                  <Triggers>
...
<div class="container">
             ...
             <div class="panel-body">
                <div class="col-md-12">
                 <div class="panel-body">
                    ...
                    <ContentTemplate>
                                          <asp:TextBox ID="TextBox1" runat="server" CssClass="dropbox" ></asp:TextBox>
                                    </ContentTemplate> 
                                       <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button3" EventName="Click" />
                    ...
                    <ContentTemplate>
                                          <asp:TextBox ID="TextBox2" runat="server" CssClass="dropbox" ></asp:TextBox>
                                     </ContentTemplate> 
                                       <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button3" EventName="Click" />
                    ...
                    <ContentTemplate>
                                     <asp:DropDownList ID="DropDownList8" runat="server" CssClass="dropbox" AutoPostBack="true"></asp:DropDownList>   
                                      </ContentTemplate> 
                                       <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button3" EventName="Click" />
                    ...
                    <ContentTemplate>
                                   <asp:DropDownList ID="DropDownList9" runat="server" CssClass="dropbox" AutoPostBack="true"></asp:DropDownList>
                                        </ContentTemplate> 
                                         <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button3" EventName="Click" />
                    ...
                    <ContentTemplate>
                                          <asp:TextBox ID="TextBox3" runat="server" CssClass="dropbox" ></asp:TextBox>
                                     </ContentTemplate> 
                                         <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button3" EventName="Click" />
                    ...
                    <ContentTemplate>
                                          <asp:TextBox ID="TextBox6" runat="server" CssClass="dropbox" ></asp:TextBox>
                                     </ContentTemplate> 
                                         <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button3" EventName="Click" />
                    ...
                    <ContentTemplate>
                                    <asp:TextBox ID="TextBox10" runat="server" class="dropbox"></asp:TextBox>
                                     </ContentTemplate> 
                               <Triggers>
             ...
             <div class="panel-body">
                <div class="col-md-12">
                 <div class="panel-body">
                    ...
                    <ContentTemplate>
                                         <asp:DropDownList ID="DropDownList10" Width="50px" Height="30px" runat="server">
                                        ...
                                        <asp:ListItem>Dr.</asp:ListItem>
                                            ...
                                            ID="TextBox7" runat="server" Width="128px" ></asp:TextBox>&nbsp;<asp:TextBox ID="TextBox15" runat="server" ></asp:TextBox> 
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button6" EventName="Click" />
                    ...
                    <ContentTemplate>
                                          <asp:TextBox ID="TextBox8" runat="server" CssClass="dropbox" ></asp:TextBox>
                                     </ContentTemplate> 
                                       <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button6" EventName="Click" />
                    ...
                    <ContentTemplate>
                                          <asp:TextBox ID="TextBox13" runat="server" CssClass="dropbox" ></asp:TextBox>
                                     </ContentTemplate> 
                                         <Triggers>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button6" EventName="Click" />
                    ...
                    <ContentTemplate>
                                          <asp:TextBox ID="TextBox14" runat="server" CssClass="dropbox" ></asp:TextBox>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button6" EventName="Click" />
                           ...
                           <div style="padding:10px; margin-top:-12px;   border-radius:10px; border:1px solid #e5e5e5; overflow:hidden; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Valid Till<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList12" runat="server" CssClass="dropbox">
     ...
     <div class="col-md-6">
                       <div class="panel-body">
                            <div class="form-horizontal">
                                 <div class="form-group"><label class="col-lg-3 control-label">Quote Stage</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList13" runat="server" CssClass="dropbox"></asp:DropDownList></div>
                                </div>
                                 <div class="form-group"><label class="col-lg-3 control-label">Delivery Period</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList14" runat="server" CssClass="dropbox">
                                       
                                        </asp:DropDownList></div>
                                </div>
                               
                                
                                <div class="form-group"><label class="col-lg-3 control-label">Carrier<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList6" runat="server" class="dropbox">
                                        <asp:ListItem>Nazeer</asp:ListItem>
                                        </asp:DropDownList></div>
                                </div>

                                <div class="form-group"><label class="col-lg-3 control-label">Payments Terms<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList1" runat="server" class="dropbox">
                                        <asp:ListItem>Nazeer</asp:ListItem>
                                        </asp:DropDownList></div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Currency<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList2" runat="server" class="dropbox">
                                        <asp:ListItem>Nazeer</asp:ListItem>
                                        </asp:DropDownList></div>
                                </div>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Share with</label>
                                    ...
                                    <div class="col-lg-9"><asp:TextBox ID="TextBox18" runat="server" class="dropbox"></asp:TextBox></div>
                                </div>
...
<div class="container">
  ...
  <div class="panel panel-default">
    <div class="panel-heading open1">Address Information</div>
    <div class="panel-body close1">
     <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               
                                 <div class="form-group"><label class="col-lg-3 control-label">Billing Address</label>

                                    <div class="col-lg-9"> <asp:TextBox ID="TextBox4" runat="server" CssClass="dropbox"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Billing City</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox11" runat="server" CssClass="dropbox"></asp:TextBox></div>
                                </div>

                                  <div class="form-group"><label class="col-lg-3 control-label">BIlling state</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox16" runat="server" CssClass="dropbox"></asp:TextBox></div>
                                </div>
                                 <div class="form-group"><label class="col-lg-3 control-label">BIlling Zip Code</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox22" runat="server" CssClass="dropbox"></asp:TextBox></div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">BIlling Country</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList3" runat="server" CssClass="dropbox"></asp:DropDownList></div>
                                </div>
     ...
     <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Shipping Address</label>

                                    <div class="col-lg-9"> <asp:TextBox ID="TextBox12" runat="server" CssClass="dropbox"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Shipping City</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox20" runat="server" CssClass="dropbox"></asp:TextBox></div>
                                </div>

                                  <div class="form-group"><label class="col-lg-3 control-label">Shipping state</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox21" runat="server" CssClass="dropbox"></asp:TextBox></div>
                                </div>
                                 <div class="form-group"><label class="col-lg-3 control-label">Shipping Zip Code</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox23" runat="server" CssClass="dropbox"></asp:TextBox></div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Shipping Country</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList5" runat="server" CssClass="dropbox"></asp:DropDownList></div>
                                </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading open1">Terms & Conditions</div>
    <div class="panel-body close1">
     <div class="col-md-12">
         <asp:TextBox ID="TextBox24" runat="server" CssClass="dropbox2" ></asp:TextBox>       
  ...
  <div class="panel panel-default">
    <div class="panel-heading open1">Bank details</div>
    <div class="panel-body close1">
     <div class="col-md-12">
         <asp:TextBox ID="TextBox25" runat="server" CssClass="dropbox2" ></asp:TextBox>       
  ...
  <div class="panel panel-default">
    <div class="panel-heading open1">Item</div>
    <div class="panel-body close1">
     <div class="col-md-12">
         <asp:TextBox ID="TextBox26" runat="server" CssClass="dropbox2" ></asp:TextBox>       
