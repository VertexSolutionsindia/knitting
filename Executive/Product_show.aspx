<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_show.aspx.cs" Inherits="Product_show" %>
...
arrow"></span></a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                <h2><asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;&nbsp;<span style="font-size:16px">Created On <asp:Label ID="Label2" runat="server" Text=""></asp:Label></span><Span style="float:right">  </h2>
  ...
  <div class="col-md-12">
    <div class="col-md-3 s1">
           <div>
           <h1 style="text-align:center; padding-top:10px;">Part No</h1>
...
<div>
           <h1 style="text-align:center; padding-top:10px;">Category</h1>
...
<div>
           <h1 style="text-align:center; padding-top:10px;">Price(INR)</h1>
    ...
    <div class="col-md-12">
    <div class="col-md-4 s5 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Created Date</h4>
           <h4 style="text-align:center; "><asp:Label ID="Label7" runat="server" Text=""></asp:Label></h1>
           
           </div>  

    </div>
   
     <div class="col-md-4 s6 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Created Before</h4>
           <h4 style="text-align:center; "><asp:Label ID="Label8" runat="server" Text=""></asp:Label></h1>
           
           </div>  

    </div>
      
     <div class="col-md-4 s7 text-center">
           <div>
           <h4 style="text-align:center; padding-top:10px;">Size</h4>
           <h4 style="text-align:center; "><asp:Label ID="Label9" runat="server" Text=""></asp:Label></h1>
