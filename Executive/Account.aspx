<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account.aspx.cs" Inherits="RabbitAccount" %>
...
arrow"></span></a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                <h2>Accounts list <Span style="float:right">
  ...
  <asp:DropDownList ID="DropDownList1" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true"  ></asp:DropDownList></div>
   <div class="col-md-2"><h3>Customer Type:</h3>
   <asp:DropDownList ID="DropDownList2" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList></div>
    ...
    <div class="col-md-2"><h3>Active:</h3>
    <asp:DropDownList ID="DropDownList5" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" >
      ...
      <div class="col-md-2"><h3>Rating:</h3>
       ...
       <Columns>
        <asp:TemplateField HeaderText="Name">
            <ItemTemplate>
               ...
               <asp:LinkButton ID="LinkButton3" runat="server" OnClick="lnkView_Click"  CssClass="goo" Text='<%# Eval("Account_name") %>'>LinkButton</asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
         
           <asp:BoundField HeaderText="Rating" DataField="ratings" />
           <asp:BoundField HeaderText="Owner" DataField="Assign_to" />
           <asp:BoundField HeaderText="Type" DataField="Customer_type" />
