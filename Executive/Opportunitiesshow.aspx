<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Opportunitiesshow.aspx.cs" Inherits="Opportunitiesshow" %>
...
arrow"></span></a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                <h2><asp:Label ID="Label1" runat="server" Text=""></asp:Label>&nbsp;&nbsp;<span style="font-size:16px">Created By <asp:Label ID="Label2" runat="server" Text=""></asp:Label>&nbsp;On <asp:Label ID="Label10" runat="server" Text=""></asp:Label></span><Span style="float:right">  <asp:LinkButton ID="btnRandom" runat="server" CssClass="btn btn-primary" 
                                        onclick="btnRandom_Click"    ><span aria-hidden="true" class="glyphicon glyphicon-edit"></span> &nbsp;EDIT</asp:LinkButton>   <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-primary"    ><span aria-hidden="true" class="glyphicon glyphicon-export"></span> &nbsp;Duplicate</asp:LinkButton>   
                                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-primary" 
                                        onclick="LinkButton2_Click"     ><span aria-hidden="true" class="glyphicon glyphicon-remove"></span> &nbsp;Delete</asp:LinkButton> </Span> <small></small></h2>
  ...
  <div class="col-md-12">
    <div class="col-md-3 s1">
           <div>
           <h1 style="text-align:center; padding-top:10px;">Account</h1>
           <h1 style="text-align:center; "><asp:Label ID="Label3" runat="server" Text=""></asp:Label></h1>
...
<div>
           <h1 style="text-align:center; padding-top:10px;">Value</h1>
            <h1 style="text-align:center; "><asp:Label ID="Label4" runat="server" Text=""></asp:Label></h1>
...
<div>
           <h1 style="text-align:center; padding-top:10px;">Contact</h1>
            <h1 style="text-align:center; "><asp:Label ID="Label5" runat="server" Text=""></asp:Label></h1>
     ...
     <div class="col-md-3 s4">
         <div>
           <h1 style="text-align:center; padding-top:10px;">Close Date</h1>
            <h1 style="text-align:center; "><asp:Label ID="Label6" runat="server" Text=""></asp:Label></h1>
...
<div class="panel-body">
  ...
  <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Industry</h4>
           <h4 style="text-align:center;font-size:20px;color:#333333 "><asp:Label ID="Label12" runat="server" Text=""></asp:Label></h1>
     ...
     <div class="col-md-12 s6 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Last Modified</h4>
   ...
   <div class="col-md-6">
     <div class="col-md-12 s6 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Source</h4>
     ...
     <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Opp Since</h4>
  ...
  <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Status</h4>
     ...
     <div class="col-md-12 s6 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Quotes Count</h4>
   ...
   <div class="col-md-6">
     <div class="col-md-12 s6 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Shared with</h4>
           <h4 style="text-align:center;font-size:20px;color:#333333 "><asp:Label ID="Label11" runat="server" Text=""></asp:Label></h1>
     ...
     <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Assigned To</h4>
  ...
  <div class="col-md-12 s5">
           ...
           <h4 style="  font-size:16px; padding-top:30px;">Summary</h4>
          
           
           </div>  
           <div style="float:left; width:30%">
           <h4 style="  font-size:16px; padding-top:30px;">-</h4>
          
           
           </div>  
             <div style="float:left; width:30%">
           <h4 style="  font-size:16px; padding-top:30px;"><asp:Label ID="Label23" runat="server" Text=""></asp:Label></h4>
  ...
  <div class="col-md-12 s5 text-center">
           <div style="float:left; width:30%">
           <h4 style="text-align:left;  font-size:16px; padding-top:30px;">Product</h4>
           ...
           <h4 style="text-align:left;  font-size:16px; padding-top:30px;">-</h4>
             ...
             <div style="float:left; width:30%">
           <h4 style="text-align:left;  font-size:16px; padding-top:30px;"><asp:Label ID="Label9" runat="server" Text=""></asp:Label></h4>
