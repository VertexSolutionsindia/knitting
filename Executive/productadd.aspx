<%@ Page Language="C#" AutoEventWireup="true" CodeFile="productadd.aspx.cs" Inherits="Rabbitproductadd" %>
                 ...
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Product</label>
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Part No</label>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Category</label>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Price(INR)</label>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Active</label>
                                    ...
                                    <div class="col-lg-9"><asp:CheckBox ID="CheckBox1" runat="server" Text="Active"></asp:CheckBox> &nbsp;&nbsp;<asp:CheckBox ID="CheckBox2" runat="server" Text="Inactive"></asp:CheckBox></div>
                                </div>
