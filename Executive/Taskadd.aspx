    ...
    <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Task</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox2" runat="server" class="form-control input-x2 dropbox"></asp:TextBox> 
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Type</label>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Assigned To</label>
                                    ...
                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList3" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%"  >
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Priority</label>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Due Date</label>

                                    <div class="col-lg-9">
                                    
                                    <asp:TextBox ID="TextBox5" runat="server" class="dropbox"></asp:TextBox>
                                    <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBox5" PopupButtonID="TextBox5"></asp:CalendarExtender>
                                    
                                    
                                    </div>
                                </div>
                                  <div class="form-group"><label class="col-lg-3 control-label">Due Time</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList4" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%"  >
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Reminder</label>

                                    <div class="col-lg-9"><asp:CheckBox ID="CheckBox1" runat="server" Text="SMS" Width="50%"></asp:CheckBox><asp:CheckBox ID="CheckBox2"  Width="50%" runat="server" Text="Email"></asp:CheckBox></div>
                                </div>
                            </div>
                      </div>
