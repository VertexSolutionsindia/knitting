<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ticketadd.aspx.cs" Inherits="Ticketadd" %>
  ...
  <div class="panel-body">
    <div class="col-md-6">
                 <div class="panel-body">
                           ...
                           <br />
                                <div class="form-group"><label class="col-lg-3 control-label">Ticket No<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox17" runat="server" class="form-control input-x2 dropbox"></asp:TextBox> 
                                    </div>
                                </div>
                               <div class="form-group"><label class="col-lg-3 control-label">Ticket<span style="color:Red">*</span></label>
                                     ...
                                     <asp:UpdatePanel ID="UpdatePanel112" runat="server" >
                                         <ContentTemplate>
                                           <asp:DropDownList ID="DropDownList4" runat="server" 
                                             CssClass="dropbox" AutoPostBack="true" onselectedindexchanged="DropDownList4_SelectedIndexChanged"></asp:DropDownList>
                                      </ContentTemplate> 
                                  <Triggers>
...
<div class="container">
             ...
             <div class="panel-body">
                <div class="col-md-12">
                 <div class="panel-body">
                    ...
                    <ContentTemplate>
                                         <asp:DropDownList ID="DropDownList10" Width="100px" Height="30px" runat="server"  CssClass="dropbox"  AutoPostBack="true" >
                                        ...
                                        <asp:ListItem>Dr.</asp:ListItem>
                                            ...
                                            ID="TextBox7" runat="server" class="form-control input-x2 dropbox" ></asp:TextBox><asp:TextBox ID="TextBox15" runat="server" class="form-control input-x2 dropbox" ></asp:TextBox> 
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button6" EventName="Click" />
                           ...
                           <div style="padding:10px; margin-top:-12px;   border-radius:10px; border:1px solid #e5e5e5; overflow:hidden; background-color:#f7f8f9;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Assign To<span style="color:Red">*</span></label>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Status</label>
                                    ...
                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList5" runat="server" CssClass="dropbox">
     ...
     <div class="col-md-6">
                       <div class="panel-body">
                            ...
                            <br />
                                 <div class="form-group"><label class="col-lg-3 control-label">Priority</label>
                                    ...
                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList13" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList></div>
                                </div>
                                 <div class="form-group"><label class="col-lg-3 control-label">Category</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList14" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" >
                                        <asp:ListItem>-- Choose Option --</asp:ListItem>
                                        <asp:ListItem>Warranty</asp:ListItem>
                                        <asp:ListItem>Out Of Warranty</asp:ListItem>
                                        <asp:ListItem>AMC</asp:ListItem>
                                        <asp:ListItem>Paid Cells</asp:ListItem>
                                        <asp:ListItem>Service</asp:ListItem>
                                        <asp:ListItem>Web Application Error</asp:ListItem>
                                        <asp:ListItem>Windows Application Error</asp:ListItem>
                                        </asp:DropDownList></div>
                                </div>
           ...
           <asp:AsyncPostBackTrigger ControlID = "DropDownList7" EventName="SelectedIndexChanged" />
                                      ...
                                      <ContentTemplate>
                                   <asp:ListBox ID="ListBox2" runat="server" width="100%" Height="100px"></asp:ListBox>
           ...
           <asp:AsyncPostBackTrigger ControlID = "Button8" EventName="Click" />
                    ...
                    <ContentTemplate>
                      ...
                      <asp:ModalPopupExtender ID="ModalPopupExtender19" runat="server" TargetControlID="ImageButton5" CancelControlID="Button10" PopupControlID="Panel19" BackgroundCssClass="modelbackground">
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Product Type<span style="color:Red">*</span></label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList6" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" >
                                        <asp:ListItem>Nazeer</asp:ListItem>
                                        </asp:DropDownList></div>
                                </div>
                           ...
                           <div class="form-horizontal">
                               <br />
                                 <div class="form-group"><label class="col-lg-3 control-label">Total</label>
                                    ...
                                    <div class="col-lg-9"> <asp:TextBox ID="TextBox4" runat="server" class="form-control input-x2 dropbox"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Payment Received</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox11" runat="server" class="form-control input-x2 dropbox"></asp:TextBox></div>
                                </div>

                                  <div class="form-group"><label class="col-lg-3 control-label">Payment Pending</label>
