<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Day_wise_purchase.aspx.cs" Inherits="Admin_Day_wise_purchase" %>
...
<html lang="en">
 ...
 <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
  ...
  <div class="col-sm-12">
   ...
   <ContentTemplate>
  <h2 style="color: #990000"> Purchase Amount :</h2> <asp:TextBox ID="TextBox1" runat="server" style="font-size:30px" 
           ></asp:TextBox>
     </ContentTemplate>
       <Triggers>
