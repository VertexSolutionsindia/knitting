<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Department-Entry.aspx.cs" Inherits="Admin_Department_Entry" %>
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Department Code </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Department Name </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Floor No </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                                           ...
                                                           <div class="form-group"><label class="col-lg-3 control-label">Incharge  </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                                           ...
                                                           <div class="form-group"><label class="col-lg-3 control-label">Branch/Location  </label>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="3" 
       ...
       <asp:TemplateField HeaderText="Select">
           ...
           <asp:BoundField HeaderText="Department Code" DataField="Depart_Code"  >
           <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
           ...
           <ItemStyle CssClass="Grd1" />
              ...
              <asp:BoundField HeaderText="Floor No" DataField="floor_no" >
           <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
