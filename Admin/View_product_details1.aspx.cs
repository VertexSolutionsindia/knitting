...
public partial class Admin_View_product_details1 : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        SqlCommand CMD = new SqlCommand("select * from purchase_unbilled_entry_details where purchase_invoice='" + purchase_no + "' and  Com_Id='" + company_id + "' ORDER BY purchase_invoice asc", con);
