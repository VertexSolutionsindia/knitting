<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_sales_product_details1.aspx.cs" Inherits="Admin_View_sales_product_details1" %>
...
<div class="container">
 ...
 <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="3" 
       ...
       <Columns>
             <asp:BoundField HeaderText="S.No" DataField="s_no"  >
           ...
           <ItemStyle CssClass="Grd1" />
                ...
                <asp:BoundField HeaderText="Discount Amount" DataField="dis_amount" >
                            <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
