<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Client_Entry.aspx.cs" Inherits="Admin_Client_Entry" EnableEventValidation="false" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                <h2><font color="#820000">Client Entry</font>
                                 </h2>
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Client Code : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                                           ...
                                                           <div class="form-group"><label class="col-lg-3 control-label">Client Address : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                             ...
                             <div class="form-group"><label class="col-lg-3 control-label">Contact Person: </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Contact Number : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Order Details : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Payment Terms : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Transport : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Delivery : </label>
 ...
 <asp:Button ID="Button2" runat="server" class="btn-primary" Width="70px" Height="30px"  Text="Clear" onclick="Button2_Click" 
          ...
          AutoPostBack="true" ontextchanged="TextBox1_TextChanged1" Width="200"></asp:TextBox>
                           <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="TextBox1" WatermarkText="Search Company Name"></asp:TextBoxWatermarkExtender>
  ...
  <div class="row">
   <div class="col-md-4"><h3>Company Name : </h3>
   ...
   <asp:DropDownList ID="DropDownList2" runat="server"  class="form-control input-x2 dropbox" data-style="btn-primary1" data-width="100%" AutoPostBack="true" onselectedindexchanged="DropDownList2_SelectedIndexChanged"  ></asp:DropDownList>
        ...
        <div class="col-md-4"><h3>Contact Number :</h3>
   ...
   <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="3" 
       ...
       <Columns>
        <asp:TemplateField HeaderText="Select">
           ...
           <asp:BoundField HeaderText="Clinet Code" DataField="Client_Code"  >
           <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
           ...
           <asp:BoundField HeaderText="Client Address" DataField="Client_Address"  >
             <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
              <asp:BoundField HeaderText="Contact Details" DataField="Contact_Person"  >
               <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
             <asp:BoundField HeaderText="Contact No" DataField="Mobile_no"  >
               <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
               <asp:BoundField HeaderText="Order Details" DataField="order_details"  >
                 <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
                 <asp:BoundField HeaderText="Payment Terms" DataField="payment_terms"  >
                   <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
   ...
   <ContentTemplate>
    ...
    <asp:Panel ID="Panel2" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
       ...
       <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; " class="control-label"> Update Client  <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" /></h3>
        ...
        <tr>
        <td>
            <asp:Label ID="Label28" runat="server" Text="Client Id" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:Label ID="Label29" runat="server" Text="" ></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label2" runat="server" Text="Company Name" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
        ...
        <tr>
        <td>
            <asp:Label ID="Label30" runat="server" Text="Client Address" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox16" runat="server"   class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
            <tr>
        <td>
            <asp:Label ID="Label9" runat="server" Text="Contact Person" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
     ...
     <tr>
        ...
        <td>
         ...
         <tr>
        <td>
            <asp:Label ID="Label3" runat="server" Text="Order Details" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox7" runat="server"   class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
         <tr>
        <td>
            <asp:Label ID="Label6" runat="server" Text="Payment Terms" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox8" runat="server"   class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
         <tr>
        <td>
            <asp:Label ID="Label7" runat="server" Text="Transport" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox9" runat="server"   class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
         <tr>
        <td>
            <asp:Label ID="Label8" runat="server" Text="Delivery" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
