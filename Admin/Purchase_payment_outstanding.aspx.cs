...
public partial class Admin_Purchase_payment_outstanding : System.Web.UI.Page
{
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("purchasebill", con))
                {
        ...
        report.ReportPath = Server.MapPath("~/Admin/purchasebill.rdlc");
    ...
    private void show_category()
    {
        ...
        SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from pay_amount_status where Com_Id='" + company_id + "' and year='" + Label1.Text + "' ", con1);
    ...
    {
        SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from pay_amount_status where Buyer='" + DropDownList1.SelectedItem.Text + "' and Com_Id='" + company_id + "' and year='" + Label1.Text + "' ", con1);
        DataTable dt1 = new DataTable();
        con1.Open();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
