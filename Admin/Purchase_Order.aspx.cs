...
public partial class Admin_Purchase_Order : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select * from Purchase_Order where Pur_Order_id='" + ROW.Cells[0].Text + "' and Com_Id='" + company_id + "'", con);
        SqlDataReader dr;
        con.Open();
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            Label1.Text = dr["Pur_Order_id"].ToString();
            ...
            TextBox11.Text = dr["Req_Date"].ToString();
    ...
    protected void Button12_Click(object sender, EventArgs e)
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                SqlCommand cmd = new SqlCommand("update Purchase_Order set Material_Name='" + HttpUtility.HtmlDecode(TextBox3.Text) +
                    ...
                    "' where Pur_Order_id='" + Label1.Text + "'  and Com_Id='" + company_id + "' ", CON);

                CON.Open();
                cmd.ExecuteNonQuery();
                CON.Close();
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Purchase Order Updated successfully')", true);
                TextBox3.Text = "";
                TextBox2.Text = "";
                TextBox4.Text = "";
                TextBox11.Text = "";
            ...
            if (dr1000.Read())
            {
                ...
                foreach (GridViewRow gvrow in GridView1.Rows)
                {
                    ...
                    if (chkdelete.Checked)
                    {
                        ...
                        con.Open();
                        SqlCommand cmd = new SqlCommand("delete from Purchase_Order where Pur_Order_id='" + usrid + "' and Com_Id='" + company_id + "'", con);
                        cmd.ExecuteNonQuery();
                        con.Close();
    ...
    private void show_SupplierName()
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                SqlCommand cmd = new SqlCommand("Select * from Purchase_Order where Com_Id='" + company_id + "' ORDER BY Pur_Order_id asc", con);
                con.Open();
                DataSet ds = new DataSet();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(ds);
                ...
                DropDownList2.DataValueField = "Pur_Order_id";
        ...
        else
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                if (dr1000.Read())
                {
                    ...
                    SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                    SqlCommand cmd = new SqlCommand("insert into Purchase_Order values(@Pur_Order_id,@Material_Name,@Item_Code,@Supplier_Name,@Supplier_Address,@Mobile_no,@Order_Qty,@units,@Rolls,@Boxes,@Shipment,@Indent_no,@Req_Date,@Payment_mode,@Com_Id)", CON);
                    cmd.Parameters.AddWithValue("@Pur_Order_id", Label1.Text);
                    ...
                    cmd.ExecuteNonQuery();
                    CON.Close();
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Purchase Order Saved successfully')", true);
                    BindData();
                    show_category();
                    getinvoiceno();
                    TextBox3.Text = "";
    ...
    public static List<string> SearchCustomers1(string prefixText, int count)
    {
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            {
                cmd.CommandText = "select distinct Mobile_no from Purchase_Order where Com_Id=@Com_Id and " +
    ...
    protected void TextBox15_TextChanged(object sender, EventArgs e)
    {
        ...
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlCommand CMD = new SqlCommand("select * from Purchase_Order where Mobile_no='" + TextBox15.Text + "' and Com_Id='" + company_id + "' ", con1);
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                SqlCommand CMD = new SqlCommand("select * from Purchase_Order where Material_Name='" + DropDownList2.SelectedItem.Text + "' and  Com_Id='" + company_id + "' ORDER BY Pur_Order_id asc", con1);
                DataTable dt1 = new DataTable();
                con1.Open();
                SqlDataAdapter da1 = new SqlDataAdapter(CMD);
                da1.Fill(dt1);
    ...
    protected void ImageButton9_Click(object sender, ImageClickEventArgs e)
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("delete from Purchase_Order where Pur_Order_id='" + row.Cells[0].Text + "' and Com_Id='" + company_id + "' ", con);
                cmd.ExecuteNonQuery();
                con.Close();

                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Purchase Order Deleted Successfully')", true);
    ...
    private void getinvoiceno()
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                con1.Open();
                string query = "Select max(Pur_Order_id) from Purchase_Order where Com_Id='" + company_id + "'";
