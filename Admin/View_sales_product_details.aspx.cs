...
public partial class Admin_View_sales_product_details : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        SqlCommand CMD = new SqlCommand("select * from sales_entry_details where invoice_no='" + purchase_no + "' and  Com_Id='" + company_id + "' ORDER BY invoice_no asc", con);
