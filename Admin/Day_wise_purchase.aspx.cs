...
public partial class Admin_Day_wise_purchase : System.Web.UI.Page
{
    ...
    protected void TextBox3_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from purchase_entry where date='" + Convert.ToDateTime(TextBox3.Text).ToString("MM-dd-yyyy") + "' and Com_Id='" + company_id + "' and year='" + Label1.Text + "' ORDER BY no asc", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView1.DataSource = dt1;
