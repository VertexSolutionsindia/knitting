...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <div class="col-md-12">
   ...
   <div class="col-md-2"><h3>Material Name:</h3>

     <asp:UpdatePanel ID="UpdatePanel7" runat="server">
   <ContentTemplate>
   <asp:DropDownList ID="DropDownList2" runat="server"   
           CssClass="form-control"    data-width="100%" AutoPostBack="true" 
    ...
    <Triggers>
      ...
      <div class="col-md-2"><h3>Material Category:</h3>
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               ...
                               <div class="form-group"><label class="col-lg-3 control-label">Material Id</label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                 ...
                 <asp:AsyncPostBackTrigger ControlID="Button10" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button11" EventName="Click"  />
                                                                ...
                                                                <div ><label class="col-lg-3 control-label">Material Name</label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                        ...
                                        <div class="col-lg-3">
                                  <asp:Button ID="Button3" runat="server" Text="New" CssClass="btn-primary" 
                                         Width="100px" onclick="Button3_Click" ></asp:Button>
                                 </div>
...
<asp:Button ID="Button5" runat="server" Text="Button" style="display:none" />
    <asp:Panel ID="Panel3" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
                         HorizontalAlign="Left" ScrollBars="Both" Width="420px" Height="250px" >
       ...
       <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; float:left; " class="control-label"> </h3>Add Material Name  <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" />
        </div>
        ...
        <tr>
        <td>
            <asp:Label ID="Label2" runat="server" Text="Material Name Id" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
        ...
        <tr>
        <td>
            <asp:Label ID="Label5" runat="server" Text="Material Name" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Button ID="Button7" runat="server" CssClass="btn-primary" 
                                            onclick="Button7_Click" style="height: 26px" Text="Add Material" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            <td>
       ...
       <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" 
           TargetControlID="Button5" PopupControlID="Panel3" 
    ...
    <Triggers>
                 <asp:AsyncPostBackTrigger ControlID="Button6" EventName="Click"  />
                                ...
                                <div ><label class="col-lg-3 control-label">Material Category</label>
...
<asp:Button ID="Button15" runat="server" Text="Button" style="display:none" />
    ...
    <asp:Panel ID="Panel2" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
                         HorizontalAlign="Left" ScrollBars="Both" Width="420px" Height="300px" >
    
       
       <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; float:left; " class="control-label"> </h3>Add Material Category  <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" />
        </div>
        <div class="tablestyles">
        <table>
        ...
        <tr>
        <td>
            <asp:Label ID="Label28" runat="server" Text="Category Id" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:Label ID="Label29" runat="server" Text="" ></asp:Label></td>
        </tr>
              <tr>
        <td>
            <asp:Label ID="Label20" runat="server" Text="Material Name" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:DropDownList ID="DropDownList9" runat="server" class="form-control input-x2 dropbox"></asp:DropDownList>
        </tr>
            <caption>
                <br />
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" class="col-lg-3 control-label" 
                            Text="Material Category" Width="200px"></asp:Label>
                    </td>
                    <td>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel24" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Button ID="Button16" runat="server" CssClass="btn-primary" 
                                                onclick="Button16_Click" style="height: 26px" Text="Add Category" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>
                                <td>
       ...
       <asp:ModalPopupExtender ID="ModalPopupExtender3" runat="server" 
           TargetControlID="Button15" PopupControlID="Panel2" 
           CancelControlID="ImageButton6" BackgroundCssClass="modelbackground" >
    ...
    <br /><br />
                                    <div ><label class="col-lg-3 control-label">Description</label>
                              
                                    <div class="col-lg-6">
                                     <asp:UpdatePanel ID="UpdatePanel15" runat="server">
   <ContentTemplate>
                                  <asp:DropDownList ID="DropDownList5" runat="server" class="form-control input-x2 dropbox" AutoPostBack="true" onselectedindexchanged="DropDownList5_SelectedIndexChanged"></asp:DropDownList>
                                    </ContentTemplate>
                                     <Triggers>
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                  ...
                                  <asp:Button ID="Button13" runat="server" Text="New" CssClass="btn-primary" 
                                         Width="100px" onclick="Button13_Click" ></asp:Button>
                                 </div>
...
<asp:Button ID="Button14" runat="server" Text="Button" style="display:none" />
    ...
    <asp:Panel ID="Panel4" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
       ...
       <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; float:left; " class="control-label"> </h3>Add Description  <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" />
        </div>
        <div class="tablestyles">
        <table>
        ...
        <tr>
        <td>
            <asp:Label ID="Label7" runat="server" Text="Description Id" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:Label ID="Label8" runat="server" Text="" ></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label9" runat="server" Text="Description" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
                        ...
                        <tr>
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel17" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Button ID="Button18" runat="server" CssClass="btn-primary" 
                                            onclick="Button18_Click" style="height: 26px" Text="Add Description" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                    <ContentTemplate>
                                        <asp:Button ID="Button19" runat="server" Text="Delete" Visible="false" />
                                        &nbsp;&nbsp;&nbsp;
                                    </ContentTemplate>
                                </asp:UpdatePanel>
       ...
       <asp:ModalPopupExtender ID="ModalPopupExtender4" runat="server" 
           TargetControlID="Button14" PopupControlID="Panel4" 
   ...
   <ContentTemplate>
                                  <asp:TextBox ID="TextBox14" runat="server" class="form-control input-x2 dropbox"></asp:TextBox>
                                     ...
                                     <Triggers>
                                                                  ...
                                                                  <div class="form-group"><label class="col-lg-3 control-label">Material Code</label>
   ...
   <div ><label class="col-lg-3 control-label">Material Division</label>
                              
                                    <div class="col-lg-6">
                                     <asp:UpdatePanel ID="UpdatePanel21" runat="server">
   <ContentTemplate>
                                  <asp:DropDownList ID="DropDownList10" runat="server" class="form-control input-x2 dropbox" AutoPostBack="true" onselectedindexchanged="DropDownList5_SelectedIndexChanged"></asp:DropDownList>
                                    </ContentTemplate>
                                     <Triggers>
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                  ...
                                  <div class="col-lg-3">
                                  <asp:Button ID="Button4" runat="server" Text="New" CssClass="btn-primary" 
                                         Width="100px" onclick="Button4_Click" ></asp:Button>
                                 </div>
...
<asp:Button ID="Button20" runat="server" Text="Button" style="display:none" />
    ...
    <asp:Panel ID="Panel5" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
       ...
       <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; float:left; " class="control-label"> </h3>Add Material Division  <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" />
        </div>
        <div class="tablestyles">
        <table>
        ...
        <tr>
        <td>
            <asp:Label ID="Label21" runat="server" Text="Division Id" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
            <asp:Label ID="Label22" runat="server" Text="" ></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label23" runat="server" Text="Material Division" Width="200px" class="col-lg-3 control-label"></asp:Label></td>
        <td>
                        ...
                        <tr>
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel23" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Button ID="Button21" runat="server" CssClass="btn-primary" 
                                            onclick="Button21_Click" style="height: 26px" Text="Add Division" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel27" runat="server">
                                    <ContentTemplate>
                                        <asp:Button ID="Button22" runat="server" Text="Delete" Visible="false" />
                                        &nbsp;&nbsp;&nbsp;
                                    </ContentTemplate>
                                </asp:UpdatePanel>
       ...
       <asp:ModalPopupExtender ID="ModalPopupExtender5" runat="server" 
           TargetControlID="Button20" PopupControlID="Panel5" 
           CancelControlID="ImageButton5" BackgroundCssClass="modelbackground" >
    ...
    <Triggers>
                 <asp:AsyncPostBackTrigger ControlID="Button6" EventName="Click"  />
                                                        ...
                                                        <div class="form-group"><label class="col-lg-3 control-label">Machine Details</label>
   ...
   <ContentTemplate>
                                  <asp:TextBox ID="TextBox9" runat="server" class="form-control input-x2 dropbox"></asp:TextBox>
                                    ...
                                    <div class="form-group"><label class="col-lg-3 control-label">Colors</label>
   ...
   <ContentTemplate>
                           ...
                           <div class="form-group"><label class="col-lg-3 control-label">Shades :</label>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="3" 
       ...
       <asp:TemplateField HeaderText="Select">
           ...
           <asp:BoundField HeaderText="Material ID" DataField="Material_id"  >
           <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
           ...
           <asp:BoundField HeaderText="Material Category" DataField="Material_Category" >
             <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
          ...
          <asp:BoundField HeaderText="Material Code" DataField="Material_Code" >
           ...
           <ItemStyle CssClass="Grd1" />
            ...
            <asp:BoundField HeaderText="Material Division" DataField="Material_Division" >
             <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
              <asp:BoundField HeaderText="Machine Details" DataField="Machine_details" >
             <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
            <asp:BoundField HeaderText="Colors" DataField="Colors" >
             <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
            <asp:BoundField HeaderText="Shades" DataField="Shades" >
             <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
   ...
   <ContentTemplate>    
    <asp:Button ID="Button11" runat="server" Text="Delete Seleted Rows" CssClass="buttonbox"  OnClientClick="return validate1()"  
      ...
      <asp:Button ID="Button8" runat="server" Text="Button" style="display:none" />
        ...
        <td>
            <asp:Label ID="Label16" runat="server" Text=""></asp:Label></td>
                      ...
                      <tr>
        <td>
            <asp:Label ID="Label11" runat="server" class="col-lg-3 control-label" Width="200px" Text="Material Name"></asp:Label></td>
        <td>
           <asp:DropDownList ID="DropDownList7" runat="server" class="form-control input-x2 dropbox"></asp:DropDownList>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label17" runat="server" class="col-lg-3 control-label" Width="200px" Text="Material Category"></asp:Label></td>
        <td>
           <asp:DropDownList ID="DropDownList6" runat="server" class="form-control input-x2 dropbox"></asp:DropDownList>
        </tr>
  
                <tr>
        <td>
            <asp:Label ID="Label12" runat="server" class="col-lg-3 control-label" Width="200px" Text="Description"></asp:Label></td>
        <td>
           <asp:DropDownList ID="DropDownList8" runat="server" class="form-control input-x2 dropbox"></asp:DropDownList>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label13" runat="server" class="col-lg-3 control-label" Width="200px" Text="Model"></asp:Label></td>
        <td>
       <asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>
        </tr>
                <tr>
        <td>
            <asp:Label ID="Label14" runat="server" class="col-lg-3 control-label" Width="200px" Text="Material Code"></asp:Label></td>
        <td>
       <asp:TextBox ID="TextBox8" runat="server"></asp:TextBox>
        </tr>
                <tr>
        <td>
            <asp:Label ID="Label19" runat="server" class="col-lg-3 control-label" Width="200px" Text="Material Division"></asp:Label></td>
        <td>
        <asp:DropDownList ID="DropDownList11" runat="server" class="form-control input-x2 dropbox"></asp:DropDownList>
        </tr>
                <tr>
        <td>
            <asp:Label ID="Label25" runat="server" class="col-lg-3 control-label" Width="200px" Text="Machcine Details"></asp:Label></td>
        <td>
       <asp:TextBox ID="TextBox10" runat="server"></asp:TextBox>
        </tr>
                        <tr>
        <td>
            <asp:Label ID="Label26" runat="server" class="col-lg-3 control-label" Width="200px" Text="Colors"></asp:Label></td>
        <td>
       <asp:TextBox ID="TextBox13" runat="server"></asp:TextBox>
        </tr>
                        <tr>
        <td>
            <asp:Label ID="Label27" runat="server" class="col-lg-3 control-label" Width="200px" Text="Shades"></asp:Label></td>
        <td>
      ...
      <ContentTemplate>
            <asp:Button ID="Button9" runat="server" class="btn-primary" Text="Update" onclick="Button9_Click" onclientclick ="return confirm(' Do you want to Update this Record')"/>
              </ContentTemplate>
