...
public partial class Admin_Unbilled_payment_outstanding : System.Web.UI.Page
{
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        report.ReportPath = Server.MapPath("~/Admin/unpurchasebill.rdlc");
    ...
    private void show_category()
    {
        ...
        SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from unpay_amount_status where Com_Id='" + company_id + "' and year='" + Label1.Text + "' ", con1);
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("unbilled_purchase_pay_amount.aspx");

    }
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from unpay_amount_status where Buyer='" + DropDownList1.SelectedItem.Text + "' and Com_Id='" + company_id + "' and year='" + Label1.Text + "' ", con1);
        DataTable dt1 = new DataTable();
        con1.Open();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
