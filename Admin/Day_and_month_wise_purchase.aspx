<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Day_and_month_wise_purchase.aspx.cs" Inherits="Admin_Day_and_month_wise_purchase" %>
  ...
  <%-- <div class="col-md-2"><h3>Staff:</h3>
   ...
   <asp:DropDownList ID="DropDownList2" runat="server"  
     ...
     <Triggers>
                            ...
                            <div class="container"><div class="row"><div class="col-sm-8 col-sm-offset-4">
                    
                       <asp:UpdatePanel ID="UpdatePanel2" runat="server">
   <ContentTemplate>
  <h2 style="color: #990000"> Purchase Amount :</h2> <asp:TextBox ID="TextBox3" runat="server" style="font-size:30px" 
           ></asp:TextBox>
     </ContentTemplate>
       <Triggers>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" CssClass="Grd1" Width="100%" 
       ...
       <Columns>
           ...
           <asp:BoundField HeaderText="Invoice No" DataField="purchase_invoice"  >
