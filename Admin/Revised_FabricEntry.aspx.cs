...
public partial class Admin_Revised_FabricEntry : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select * from Revised_Fabric_Entry where Revised_Fab_id='" + ROW.Cells[1].Text + "' and Com_Id='" + company_id + "'", con);
        SqlDataReader dr;
        con.Open();
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            Label1.Text = dr["Revised_Fab_id"].ToString();
            DropDownList3.SelectedItem.Text = dr["Division"].ToString();
            TextBox13.Text = dr["Fabric_No"].ToString();
            ...
            TextBox8.Text = dr["Color_Changed"].ToString();
            TextBox4.Text = dr["Thread_Color"].ToString();
            TextBox6.Text = dr["Fabric_Quality"].ToString();
    ...
    protected void Button12_Click(object sender, EventArgs e)
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                SqlCommand cmd = new SqlCommand("update Revised_Fabric_Entry set Division='" + HttpUtility.HtmlDecode(DropDownList3.SelectedItem.Text) +
                      "', Fabric_No='" + HttpUtility.HtmlDecode(TextBox13.Text) +
                       ...
                       "',Color_2='" + HttpUtility.HtmlDecode(DropDownList8.SelectedItem.Text) +
                         "',Color_3='" + HttpUtility.HtmlDecode(DropDownList12.SelectedItem.Text) +
                          "',Color_4='" + HttpUtility.HtmlDecode(DropDownList9.SelectedItem.Text) +
                             "',Color_Changed='" + HttpUtility.HtmlDecode(TextBox8.Text) +
                          "',Thread_Color='" + HttpUtility.HtmlDecode(TextBox4.Text) +
                          "',Fabric_Quality='" + HttpUtility.HtmlDecode(TextBox6.Text) +
                    ...
                    "' where Revised_Fab_id='" + Label1.Text + "'  and Com_Id='" + company_id + "' ", CON);

                CON.Open();
                cmd.ExecuteNonQuery();
                CON.Close();
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Revised Fabric Entry Updated successfully')", true);
                TextBox3.Text = "";
                TextBox2.Text = "";
                TextBox4.Text = "";
                TextBox7.Text = "";
            ...
            if (dr1000.Read())
            {
                ...
                foreach (GridViewRow gvrow in GridView1.Rows)
                {
                    ...
                    if (chkdelete.Checked)
                    {
                        ...
                        con.Open();
                        SqlCommand cmd = new SqlCommand("delete from Revised_Fabric_Entry where Revised_Fab_id='" + usrid + "' and Com_Id='" + company_id + "'", con);
                        cmd.ExecuteNonQuery();
                        con.Close();
    ...
    private void show_ProductName()
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                SqlCommand cmd = new SqlCommand("Select * from Revised_Fabric_Entry where Com_Id='" + company_id + "' ORDER BY Revised_Fab_id asc", con);
                con.Open();
                DataSet ds = new DataSet();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(ds);
                ...
                DropDownList2.DataValueField = "Revised_Fab_id";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Please Select Fabric No')", true);
        }
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Enter Color to be Changed')", true);
        }
        else
        {
            if (User.Identity.IsAuthenticated)
            {
                ...
                if (dr1000.Read())
                {
                    ...
                    SqlConnection CON = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                    SqlCommand cmd = new SqlCommand("insert into Revised_Fabric_Entry values(@Revised_Fab_id,@Division,@Fabric_No,@Composition,@Composition_Per,@Qualifier,@Weight,@Yarn_Count_1,@Yarn_Count_2,@Yarn_Count_3,@Color_1,@Color_2,@Color_3,@Color_4,@Color_Changed,@Thread_Color,@Fabric_Quality,@Time_Consume,@Times_Dtl,@Com_Id,@Product_Name,@Quality_Check)", CON);
                    cmd.Parameters.AddWithValue("@Revised_Fab_id", Label1.Text);
                    cmd.Parameters.AddWithValue("@Division", HttpUtility.HtmlDecode(DropDownList3.SelectedItem.Text));
                    cmd.Parameters.AddWithValue("@Fabric_No", HttpUtility.HtmlDecode(TextBox13.Text));
                    ...
                    cmd.Parameters.AddWithValue("@Color_Changed", HttpUtility.HtmlDecode(TextBox8.Text));
                    cmd.Parameters.AddWithValue("@Thread_Color", HttpUtility.HtmlDecode(TextBox4.Text));
                    cmd.Parameters.AddWithValue("@Fabric_Quality", HttpUtility.HtmlDecode(TextBox6.Text));
                    ...
                    cmd.ExecuteNonQuery();
                    CON.Close();
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Revised Fabric Entry Saved successfully')", true);
                    TextBox3.Text = "";
                    TextBox2.Text = "";
                    TextBox4.Text = "";
                    TextBox7.Text = "";
    ...
    public static List<string> SearchFabricNo(string prefixText, int count)
    {
        using (SqlConnection conn = new SqlConnection())
        {
            conn.ConnectionString = ConfigurationManager.AppSettings["connection"];
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "select distinct Fab_Pro_id from Fabric_Entry where Com_Id=@Com_Id and " +
                "Fab_Pro_id like @Fab_Pro_id + '%'";
                cmd.Parameters.AddWithValue("@Fab_Pro_id", prefixText);
                cmd.Parameters.AddWithValue("@Com_Id", company_id);
                cmd.Connection = conn;
                conn.Open();
                List<string> customers = new List<string>();
                using (SqlDataReader sdr = cmd.ExecuteReader())
                {
                    while (sdr.Read())
                    {
                        customers.Add(sdr["Fab_Pro_id"].ToString());
                    }
                }
                conn.Close();
                return customers;
    ...
    protected void ImageButton9_Click(object sender, ImageClickEventArgs e)
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("delete from Revised_Fabric_Entry where Revised_Fab_id='" + row.Cells[1].Text + "' and Com_Id='" + company_id + "' ", con);
                cmd.ExecuteNonQuery();
                con.Close();

                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Revised Fabric Entry Deleted Successfully')", true);
    ...
    private void getinvoiceno()
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                con1.Open();
                string query = "Select max(Revised_Fab_id) from Revised_Fabric_Entry where Com_Id='" + company_id + "'";
    ...
    protected void DropDownList2_SelectedIndexChanged1(object sender, EventArgs e)
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                SqlCommand CMD = new SqlCommand("select * from Revised_Fabric_Entry where Product_Name='" + DropDownList2.SelectedItem.Text + "' and  Com_Id='" + company_id + "' ORDER BY Revised_Fab_id asc", con1);
                DataTable dt1 = new DataTable();
                con1.Open();
                SqlDataAdapter da1 = new SqlDataAdapter(CMD);
                da1.Fill(dt1);
    ...
    protected void TextBox15_TextChanged(object sender, EventArgs e)
    {
        if (User.Identity.IsAuthenticated)
        {
            ...
            if (dr1000.Read())
            {
                ...
                SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
                SqlCommand CMD = new SqlCommand("select * from Revised_Fabric_Entry where Division='" + TextBox15.Text + "' and  Com_Id='" + company_id + "' ORDER BY Revised_Fab_id asc", con1);
                DataTable dt1 = new DataTable();
                con1.Open();
                SqlDataAdapter da1 = new SqlDataAdapter(CMD);
                da1.Fill(dt1);
    ...
    protected void TextBox13_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd = new SqlCommand("select * from Fabric_Entry where Fab_Pro_id='" + TextBox13.Text + "' and Com_Id='" + company_id + "'", con);
        SqlDataReader dr;
        con.Open();
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            ...
            DropDownList12.SelectedItem.Text = dr["Color_3"].ToString();
            DropDownList9.SelectedItem.Text = dr["Color_4"].ToString();
            TextBox4.Text = dr["Fabric_Finis_1"].ToString();
            TextBox6.Text = dr["Fabric_Finish_2"].ToString();
            TextBox12.Text = dr["Time_Consume"].ToString();
            DropDownList4.SelectedItem.Text = dr["Times_Dtl"].ToString();
            TextBox10.Text = dr["Product_Name"].ToString();
            DropDownList5.SelectedItem.Text = dr["Quality_Check"].ToString();
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert Message", "alert('Invalid Fabric ID')", true);
            TextBox3.Text = "";
            TextBox2.Text = "";
            TextBox4.Text = "";
            TextBox7.Text = "";
