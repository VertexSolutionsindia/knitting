...
public partial class Admin_Day_and_month_wise_purchase : System.Web.UI.Page
{
    ...
    protected void TextBox1_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from purchase_entry where date='" + TextBox1.Text + "' and Com_Id='" + company_id + "' ORDER BY no asc", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView1.DataSource = dt1;
    ...
    protected void TextBox2_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from purchase_entry where date between  '" + Convert.ToDateTime(TextBox1.Text).ToString("MM-dd-yyyy") + "' and '" + Convert.ToDateTime(TextBox2.Text).ToString("MM-dd-yyyy") + "' and  Com_Id='" + company_id + "' ORDER BY no asc", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView1.DataSource = dt1;
    ...
    protected void DropDownList3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("SELECT DISTINCT CONVERT(VARCHAR(10),month(date),101)  as Month,sum(Grand__total) as Amount FROM purchase_entry as a where month(date)='" + month + "' and year(date)='" + year + "' and  Com_Id='" + company_id + "' group by month(date)", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView1.DataSource = dt1;
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("SELECT DISTINCT CONVERT(VARCHAR(10),year(date),101)  as Year,sum(Grand__total) as Amount FROM purchase_entry as a where year(date)='" + year + "' and  Com_Id='" + company_id + "' group by year(date)", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView1.DataSource = dt1;
