<%@ Page Language="C#" AutoEventWireup="true" CodeFile="accountsadd.aspx.cs" Inherits="Rabbitaccountsadd" %>
                           ...
                           <div class="form-horizontal">
                               <br />
                                 <div class="form-group"><label class="col-lg-3 control-label">TIN No</label>
                                    ...
                                    <div class="col-lg-9"><asp:TextBox ID="TextBox1" runat="server" class="form-control input-x2 dropbox"></asp:TextBox> 
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">CST No</label>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Service Tax No</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox7" runat="server" class="form-control input-x2 dropbox"></asp:TextBox></div>
                                </div>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Pan No</label>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Supplier</label>
                                    ...
                                    <div class="col-lg-9"><asp:CheckBox ID="CheckBox1" runat="server"></asp:CheckBox></div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Billing City</label>
                                 ...
                                 <div class="form-group"><label class="col-lg-3 control-label">Billing Zip Code</label>
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Billing Country</label>
                                    ...
                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList8" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%"  ></asp:DropDownList></div>
                                </div>
     ...
     <div class="col-md-6">
                       <div class="panel-body">
                            <div class="form-horizontal">
                                    ...
                                    <br />
                              <div class="form-group"><label class="col-lg-3 control-label">No of Employees</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList9" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" ></asp:DropDownList> 
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Annual Revenue</label>

                                    <div class="col-lg-9"><asp:TextBox ID="TextBox2" runat="server"  class="form-control input-x2 dropbox"></asp:TextBox></div>
                                </div>

                                  <div class="form-group"><label class="col-lg-3 control-label">Ownership</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList11" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" ></asp:DropDownList></div>
                                </div>

                                 <div class="form-group"><label class="col-lg-3 control-label">Compaign</label>

                                    <div class="col-lg-9"><asp:DropDownList ID="DropDownList12" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%"> </asp:DropDownList></div>
                                </div>

                                  <div class="form-group"><label class="col-lg-3 control-label">Compaign Type</label>
