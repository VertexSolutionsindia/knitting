...
arrow"></span></a>
  ...
  <div class="col-md-12">
   ...
   <div class="col-md-2" ><h3>Assigned To:</h3>
  <asp:DropDownList ID="DropDownList1" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true"  ></asp:DropDownList></div>
   <div class="col-md-2"><h3>Status:</h3>
   <asp:DropDownList ID="DropDownList2" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList></div>
    <div class="col-md-2"><h3>category:</h3>
    <asp:DropDownList ID="DropDownList6" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList></div>
    <div class="col-md-2"><h3>Created:</h3>
    <asp:DropDownList ID="DropDownList3" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList></div>
    <div class="col-md-2"><h3>Modified Date:</h3>
    <asp:DropDownList ID="DropDownList5" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList></div>
  ...
  <div class="panel-body">
                        <div class="col-md-12" >
                                <div class="panel-heading">
                                    <h4 class="panel-title">Show &nbsp;<asp:DropDownList ID="DropDownList4" runat="server" class="dropbox1" style="margin-top:10px;"></asp:DropDownList>&nbsp; entries </h4>
...
<div style="font-size:14px; padding:10px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif;">
   <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
        ...
        onrowdatabound="GridView1_RowDataBound" PageSize="5" ForeColor="#333333" >
       ...
       <Columns>
         ...
         <asp:TemplateField HeaderText="Name">
            <ItemTemplate>
               ...
               <asp:LinkButton ID="LinkButton3" runat="server"  CssClass="goo" OnClick="lnkView_Click"  Text='<%# Eval("Ticket_no") %>'>LinkButton</asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
           
           <asp:BoundField HeaderText="Title" DataField="Ticket" />
           <asp:BoundField HeaderText="Account" DataField="Account" />
           <asp:BoundField HeaderText="Product" DataField="product" />
           <asp:BoundField HeaderText="Serial No" DataField="" 
               DataFormatString="{0:d}" ShowHeader="False" />
           <asp:BoundField DataField="status" HeaderText="Status" />
           <asp:BoundField DataField="assign_to" HeaderText="Assigned To" />
           <asp:BoundField HeaderText="Open Since" />
       ...
       <RowStyle Height="30px" BackColor="#F7F6F3" ForeColor="#333333" />
