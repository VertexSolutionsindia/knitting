<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leads.aspx.cs" Inherits="Rabbitleads" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title see2">
                                <h2>Leads list <Span style="float:right">  <asp:LinkButton ID="btnRandom" runat="server" CssClass="btn btn-primary" 
  ...
  <asp:DropDownList ID="DropDownList1" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true"  >
   ...
   <asp:DropDownList ID="DropDownList2" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" ></asp:DropDownList></div>
    ...
    <asp:DropDownList ID="DropDownList5" runat="server"  CssClass="selectpicker" data-style="btn-primary1" data-width="100%" AutoPostBack="true" >
      ...
      <div class="col-md-2"><h3>Leads Source:</h3>
       ...
       <Columns>
        <asp:TemplateField HeaderText="Name">
            <ItemTemplate>
               ...
               <asp:LinkButton ID="LinkButton3" runat="server"  CssClass="goo" OnClick="lnkView_Click"  Text='<%# Eval("Lead_name") %>'>LinkButton</asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Lead Source" DataField="lead_source" 
               DataFormatString="{0:d}" ShowHeader="False" />
           <asp:BoundField HeaderText="Created" DataField="" />
       </Columns>
