<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ticketshow.aspx.cs" Inherits="Ticketshow" %>
...
arrow"></span></a>
  ...
  <div class="col-md-12">
    <div class="col-md-3 s1">
           <div>
           <h1 style="text-align:center; padding-top:10px;">Ticket No</h1>
...
<div>
     ...
     <div class="col-md-3 s4">
         <div>
           <h1 style="text-align:center; padding-top:10px;">Priority</h1>
...
<div class="panel-body">
  ...
  <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Closed Onn</h4>
     ...
     <div class="col-md-12 s6 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Modified</h4>
     ...
     <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Last Service Done</h4>
   ...
   <div class="col-md-6">
     ...
     <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Product Type</h4>
     ...
     <div class="col-md-12 s6 text-center">
           <div>
           <h4 style="text-align:center; font-size:16px; padding-top:10px;">Category</h4>
     ...
     <div class="col-md-12 s5 text-center">
           <div>
           <h4 style="text-align:center;  font-size:16px; padding-top:10px;">Last Service Done By</h4>
